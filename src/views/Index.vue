    ...
    <van-popup v-model="show" closeable round>
      <div class="pop_view">
        ...
        <div style="text-align:left">
          ...
          投票规则：每个微信号每天可以投票10次（每天可为同一作品投票10次）
        </div>
        <div style="text-align:left">
          <van-icon name="orders-o" color="#1989fa" />
          活动介绍：海峡两岸暨港澳无人机航拍创作大赛自2017年经国务院台湾事务办公室批准并立项，至今已在深圳成功举办三届，并发展成为航拍领域最权威的赛事，是国家级重点交流活动。“第四届海峡两岸暨港澳无人机航拍创作大赛”已于8月20日正式启动作品征集工作，海峡两岸暨港澳专业队伍报名踊跃。大赛将由组委会专家评出金、银、铜奖，及网络人气奖、传媒关注奖等团体奖，最佳编剧奖、最佳飞手奖、最佳云台手奖、最佳剪辑奖、校园新锐奖等个人奖及其它专项奖，并颁发丰厚的奖金，其中最高奖金金额达3万元人民币。
        </div>
      </div>
    </van-popup>
  </div>
